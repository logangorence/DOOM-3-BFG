...
CLASS_DECLARATION(idEntity, idTarget)END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_Remove)EVENT(EV_Activate, idTarget_Remove::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_Show)EVENT(EV_Activate, idTarget_Show::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_Damage)EVENT(EV_Activate, idTarget_Damage::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_SessionCommand)
                EVENT(EV_Activate, idTarget_SessionCommand::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_EndLevel)EVENT(EV_Activate, idTarget_EndLevel::Event_Activate) END_CLASS
            ...
            switch (expansion) {
                    ...
                    switch (g_skill.GetInteger()) {
                        case 3:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_ROE_COMPLETED_DIFFICULTY_3);
                        case 2:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_ROE_COMPLETED_DIFFICULTY_2);
                        case 1:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_ROE_COMPLETED_DIFFICULTY_1);
                        case 0:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_ROE_COMPLETED_DIFFICULTY_0);
                        default:
                            break;
                    }
                    break;
                case GAME_D3LE:
                    ...
                    switch (g_skill.GetInteger()) {
                        case 3:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_LE_COMPLETED_DIFFICULTY_3);
                        case 2:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_LE_COMPLETED_DIFFICULTY_2);
                        case 1:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_LE_COMPLETED_DIFFICULTY_1);
                        case 0:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_LE_COMPLETED_DIFFICULTY_0);
                        default:
                            break;
                    }
                    break;
                case GAME_BASE:
                    ...
                    switch (g_skill.GetInteger()) {
                        case 3:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_COMPLETED_DIFFICULTY_3);
                        case 2:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_COMPLETED_DIFFICULTY_2);
                        case 1:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_COMPLETED_DIFFICULTY_1);
                        case 0:
                            player->GetAchievementManager().EventCompletesAchievement(
                                    ACHIEVEMENT_COMPLETED_DIFFICULTY_0);
                        default:
                            break;
                    }
                    break;
...
CLASS_DECLARATION(idTarget, idTarget_WaitForButton)EVENT(EV_Activate, idTarget_WaitForButton::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_SetGlobalShaderTime)
                EVENT(EV_Activate, idTarget_SetGlobalShaderTime::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_SetShaderParm)EVENT(EV_Activate, idTarget_SetShaderParm::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_SetShaderTime)EVENT(EV_Activate, idTarget_SetShaderTime::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_FadeEntity)EVENT(EV_Activate, idTarget_FadeEntity::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_LightFadeIn)EVENT(EV_Activate, idTarget_LightFadeIn::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_LightFadeOut)EVENT(EV_Activate, idTarget_LightFadeOut::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_Give)EVENT(EV_Activate, idTarget_Give::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_GiveEmail)EVENT(EV_Activate, idTarget_GiveEmail::Event_Activate) END_CLASS
...
void idTarget_GiveEmail::Event_Activate(idEntity *activator) {
    ...
    if (pda) {
        player->GiveEmail(
                static_cast<const idDeclEmail *>( declManager->FindType(DECL_EMAIL, spawnArgs.GetString("email"),
                                                                        false)));
    } else {
...
CLASS_DECLARATION(idTarget, idTarget_SetModel)EVENT(EV_Activate, idTarget_SetModel::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_SetInfluence)EVENT(EV_Activate, idTarget_SetInfluence::Event_Activate)
                                                  EVENT(EV_RestoreInfluence,
                                                  ...
                                                  EVENT(EV_ClearFlash,
                                                        idTarget_SetInfluence::Event_ClearFlash) END_CLASS
...
void idTarget_SetInfluence::Save(idSaveGame *savefile) const {
    ...
    for (i = 0; i < savedGuiList.Num(); i++) {
        for (int j = 0; j < MAX_RENDERENTITY_GUI; j++) {
            savefile->WriteUserInterface(savedGuiList[i].gui[j],
                                         savedGuiList[i].gui[j] ? savedGuiList[i].gui[j]->IsUniqued() : false);
        }
    }
}
...
void idTarget_SetInfluence::Event_GatherEntities() {
    ...
    for (i = 0; i < listedEntities; i++) {
        ...
        if (ent) {
            ...
            if (guis && ent->GetRenderEntity() && ent->GetRenderEntity()->gui[0] &&
                ent->spawnArgs.FindKey("gui_demonic")) {
    ...
    for (i = 0; i < guiList.Num(); i++) {
        ...
        for (j = 0; j < MAX_RENDERENTITY_GUI; j++) {
            if (ent->GetRenderEntity()->gui[j] &&
                ent->spawnArgs.FindKey(j == 0 ? "gui_demonic" : va("gui_demonic%d", j + 1))) {
                //Backup the old one
                savedGuiList[i].gui[j] = ent->GetRenderEntity()->gui[j];
                ent->GetRenderEntity()->gui[j] = uiManager->FindGui(
                        ent->spawnArgs.GetString(j == 0 ? "gui_demonic" : va("gui_demonic%d", j + 1)), true);
                update = true;
            }
        }
...
CLASS_DECLARATION(idTarget, idTarget_SetKeyVal)EVENT(EV_Activate, idTarget_SetKeyVal::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_SetFov)EVENT(EV_Activate, idTarget_SetFov::Event_Activate) END_CLASS
...
void idTarget_SetFov::Event_Activate(idEntity *activator) {
    ...
    idPlayer *player = gameLocal.GetLocalPlayer();
    fovSetting.Init(gameLocal.time, SEC2MS(spawnArgs.GetFloat("time")),
                    player ? player->DefaultFov() : g_fov.GetFloat(), spawnArgs.GetFloat("fov"));
    BecomeActive(TH_THINK);
}
...
CLASS_DECLARATION(idTarget, idTarget_SetPrimaryObjective)
                EVENT(EV_Activate, idTarget_SetPrimaryObjective::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_LockDoor)EVENT(EV_Activate, idTarget_LockDoor::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_CallObjectFunction)
                EVENT(EV_Activate, idTarget_CallObjectFunction::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_EnableLevelWeapons)
                EVENT(EV_Activate, idTarget_EnableLevelWeapons::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_Tip)
                EVENT(EV_Activate, idTarget_Tip::Event_Activate) EVENT(EV_TipOff, idTarget_Tip::Event_TipOff)
                EVENT(EV_GetPlayerPos, idTarget_Tip::Event_GetPlayerPos) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_GiveSecurity)EVENT(EV_Activate, idTarget_GiveSecurity::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_RemoveWeapons)EVENT(EV_Activate, idTarget_RemoveWeapons::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_LevelTrigger)EVENT(EV_Activate, idTarget_LevelTrigger::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_Checkpoint)EVENT(EV_Activate, idTarget_Checkpoint::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_EnableStamina)EVENT(EV_Activate, idTarget_EnableStamina::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_FadeSoundClass)EVENT(EV_Activate, idTarget_FadeSoundClass::Event_Activate)
                                                    EVENT(EV_RestoreVolume,
                                                          idTarget_FadeSoundClass::Event_RestoreVolume) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_RumbleJoystick)
                EVENT(EV_Activate, idTarget_RumbleJoystick::Event_Activate) END_CLASS
...
CLASS_DECLARATION(idTarget, idTarget_Achievement)EVENT(EV_Activate, idTarget_Achievement::Event_Activate) END_CLASS
