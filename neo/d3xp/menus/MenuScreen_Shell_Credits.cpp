...
void idMenuScreen_Shell_Credits::SetupCreditList() {
    ...
    creditList.Clear();
    creditList.Append(creditInfo_t(3, "DOOM 3 BFL EDITION"));
    creditList.Append(creditInfo_t(2, "Based on RBDOOM 3 BFG EDITION"));
    creditList.Append(creditInfo_t(0, "Logan Gorence"));
...
========================
*/
bool idMenuScreen_Shell_Credits::HandleAction(idWidgetAction &action, const idWidgetEvent &event, idMenuWidget *widget,
                                              bool forceHandled) {
