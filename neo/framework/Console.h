...
enum justify_t {
    JUSTIFY_LEFT, JUSTIFY_RIGHT, JUSTIFY_CENTER_LEFT, JUSTIFY_CENTER_RIGHT
};
...
public:
    ...
    virtual void PrintOverlay(idOverlayHandle &handle, justify_t justify, VERIFY_FORMAT_STRING const char *text,
                              ...) = 0;
